<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" 
    CodeBehind="StateDetails.aspx.cs" Inherits="OMEntityWeb.State.StateDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <table cellpadding="0" cellspacing="0" align="left" style="vertical-align: top;"
        width="100%">
        <tr>
            <td colspan="6" style="padding-right: 10px; width: 944px;" class="Page_Header" align="left">State Details&nbsp;
                <asp:Button ID="btnCreateState" runat="server" Text="Create State"
                    CssClass="button-new" ValidationGroup="a" OnClick="btnCreateState_Click"  />
            </td>
        </tr>
        <tr>
                        ...
                        <asp:TemplateField HeaderText="View">
                            <ItemTemplate>
                                <asp:ImageButton ID="ImageButton4" BorderWidth="0" runat="server" ImageUrl="~/UIFiles/images/delete.png" ToolTip="Delete Department"
                                    Height="30" Text="Delete Department" OnClick="makelink_delete" CommandArgument='<%# Eval("StateID").ToString()%>' />
                                  <asp:ImageButton ID="ImgEdit" BorderWidth="0" runat="server" ImageUrl="~/UIFiles/images/edit.png" ToolTip="Edit Department"
                                      Height="30" Text="Delete Department" OnClick="makelink_edit" CommandArgument='<%# Eval("StateID").ToString()%>' />
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Left" />
