<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" 
    CodeBehind="StateEdit.aspx.cs" Inherits="OMEntityWeb.State.StateEdit" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>State Edtion</title>
        ...
        <tr>
            <td>
                ...
                <table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                        <td style="width: 60%; padding-left: 20px;" class="Page_Header"><b>State Edition</b> </td>
                    </tr>
                </table>
                            ...
                            <table border='0' cellpadding="4" width="80%">
                                ...
                                <tr>
                                    <td colspan="6" align="center">
                                        <asp:Button ID="btnstateup" runat="server" CssClass="button-new"
                                            Text="Update" OnClientClick="return checkfield();" OnClick="btnstateup_Click"  ></asp:Button>&nbsp;
