<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" 
    CodeBehind="EmpAddDetails.aspx.cs" Inherits="OMEntityWeb.EmployeeAdd.EmpAddDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table cellpadding="0" cellspacing="0" align="left" style="vertical-align: top;"
        width="100%">
        <tr>
            <td colspan="6" style="padding-right: 10px; width: 944px;" class="Page_Header" align="left">Employee Address Details&nbsp;
                <asp:Button ID="btnCreateEmployeeAdd" runat="server" Text="Create Employee Address"
                    CssClass="button-new" ValidationGroup="a" OnClick="btnCreateEmployeeAdd_Click"  />
            </td>
        </tr>
        <tr>
                        ...
                        <asp:TemplateField HeaderText="View">
                            <ItemTemplate>
                                <asp:ImageButton ID="ImageButton4" BorderWidth="0" runat="server" ImageUrl="~/UIFiles/images/delete.png" ToolTip="Delete Employee"
                                    Height="30" Text="Delete Employee" OnClick="makelink_delete" CommandArgument='<%# Eval("AddressID").ToString()%>' />
                                  <asp:ImageButton ID="ImgEdit" BorderWidth="0" runat="server" ImageUrl="~/UIFiles/images/edit.png" ToolTip="Edit Employee"
                                      Height="30" Text="Delete Employee" OnClick="makelink_edit" CommandArgument='<%# Eval("AddressID").ToString()%>' />
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Left" />
