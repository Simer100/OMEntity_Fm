...
{
    public partial class EmpAddCreate : System.Web.UI.Page
    {
        ...
        protected void btnCreateAddEmployee_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                String strerr = employee.CreateEmpAdd(mst);
                if (strerr == "0")
                {
