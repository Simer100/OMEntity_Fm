<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" 
    CodeBehind="EmpAddCreate.aspx.cs" Inherits="OMEntityWeb.EmployeeAdd.EmpAddCreate" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
      <title>Employee Address Creation</title>
                            ...
                            <table border='0' cellpadding="4" width="90%">
                                ...
                                <tr>
                                    <td colspan="6" align="center">
                                        <asp:Button ID="btnCreateAddEmployee" runat="server" CssClass="button-new"
                                            Text="Create Employee Address" OnClientClick="return checkfield();" OnClick="btnCreateAddEmployee_Click" ></asp:Button><br />
