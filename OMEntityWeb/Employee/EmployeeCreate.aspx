<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true"
    CodeBehind="EmployeeCreate.aspx.cs" Inherits="OMEntityWeb.Employee.EmployeeCreate" %>
        ...
        <tr>
            <td>
                ...
                <table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                        <td style="width: 60%; padding-left: 20px;" class="Page_Header"><b>Employee Creation</b> </td>
                    </tr>
                </table>
                            ...
                            <table border='0' cellpadding="4" width="90%">
                                ...
                                <tr>
                                    <td colspan="6" align="center">
                                        <asp:Button ID="btnCreateEmployee" runat="server" CssClass="button-new"
                                            Text="Create Employee" OnClientClick="return checkfield();" OnClick="btnCreateEmployee_Click"></asp:Button><br />
