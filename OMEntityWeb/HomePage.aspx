<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HomePage.aspx.cs" Inherits="OMEntityWeb.HomePage" %>
    ...
    <div id="page">
            ...
            <div class="ubea-container">
                <div class="row">
                    <div class="col-sm-4 col-xs-12">
                        <div id="ubea-logo"><a href="../HomePage">Orgo Employee</a></div>
                    </div>
                    <div class="col-xs-8 text-right menu-1">
                        <ul>
                            <li><a href="../Employee/EmployeeDetails">Employee</a></li>
                                <li><a href="../Department/DepDetails">Department</a></li>
                                <li><a href="../State/StateDetails">State</a></li>
                                <li><a href="../EmployeeAdd/EmpAddDetails">Office Address</a></li>
                                <li><a href="../Enroll/EnrollDetails">Employee Enrollment</a></li>
                        </ul>
                    </div>
                </div>
        ...
        <div id="ubea-hero" class="js-fullheight" data-section="home">
            <div class="flexslider js-fullheight">
                <ul class="slides">
                    <li style="background-image:url(../../UIFiles/images/img_1.jpg);">
                    ...
                    <li style="background-image: url(../../UIFiles/images/img_bg_2.jpg);">
                        <div class="overlay"></div>
                        <div class="container">
                            <div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
                                <div class="slider-text-inner">
                    ...
                    <li style="background-image: url(../../UIFiles/images/img_bg_3.jpg);">
                        <div class="overlay"></div>
                        <div class="container">
                            <div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
                                <div class="slider-text-inner">
