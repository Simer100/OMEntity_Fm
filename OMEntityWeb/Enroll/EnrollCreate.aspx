<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" 
    CodeBehind="EnrollCreate.aspx.cs" Inherits="OMEntityWeb.Enroll.EnrollCreate" %>
                                ...
                                <tr>
                                    <td colspan="6" align="center">
                                        <asp:Button ID="btnCreateEnroll" runat="server" CssClass="button-new"
                                            Text="Create Employee Address" OnClientClick="return checkfield();" OnClick="btnCreateEnroll_Click" ></asp:Button><br />
