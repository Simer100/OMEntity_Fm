<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true"
    CodeBehind="EnrollDetails.aspx.cs" Inherits="OMEntityWeb.Enroll.EnrollDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <table cellpadding="0" cellspacing="0" align="left" style="vertical-align: top;"
        width="100%">
        <tr>
            <td colspan="6" style="padding-right: 10px; width: 944px;" class="Page_Header" align="left">Enrollment Details&nbsp;
                <asp:Button ID="btnCreateEmpEnroll" runat="server" Text="Create Enrollment"
                    CssClass="button-new" ValidationGroup="a" OnClick="btnCreateEmpEnroll_Click"   />
            </td>
        </tr>
        <tr>
            ...
            <td colspan="6" align="left" style="height: 10px;">
                <asp:GridView Width="100%" ID="grdEmployeeInfo" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="Department" DataField="DepMst.Dept_Name">
                            <HeaderStyle HorizontalAlign="Left" />
                            <ItemStyle Width="10%" />
                        </asp:BoundField>
                        <asp:BoundField HeaderText="Employee Name" DataField="EmployeeMst.FirstName">
                            <HeaderStyle HorizontalAlign="Left" />
                            <ItemStyle Width="5%" />
                        </asp:BoundField>
                        <asp:BoundField HeaderText="State Name" DataField="StateMst.State_Name">
                            <HeaderStyle HorizontalAlign="Left" />
                            <ItemStyle Width="10%" />
                        </asp:BoundField>
                        <asp:TemplateField HeaderText="View">
                            <ItemTemplate>
                                <asp:ImageButton ID="ImageButton4" BorderWidth="0" runat="server" ImageUrl="~/UIFiles/images/delete.png" ToolTip="Delete"
                                    Height="30" Text="Delete" OnClick="makelink_delete" CommandArgument='<%# Eval("EnrollmentID").ToString()%>' />
                                  <asp:ImageButton ID="ImgEdit" BorderWidth="0" runat="server" ImageUrl="~/UIFiles/images/edit.png" ToolTip="Edit"
                                      Height="30" Text="Delete" OnClick="makelink_edit" CommandArgument='<%# Eval("EnrollmentID").ToString()%>' />
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Left" />
