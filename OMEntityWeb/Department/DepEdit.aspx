<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="DepEdit.aspx.cs" Inherits="OMEntityWeb.Department.DepEdit" %>
        ...
        <tr>
            <td>
                ...
                <table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                        <td style="width: 60%; padding-left: 20px;" class="Page_Header"><b>Department Edition</b> </td>
                    </tr>
                </table>
                            ...
                            <table border='0' cellpadding="4" width="80%">
                                ...
                                <tr>
                                    <td colspan="6" align="center">
                                        <asp:Button ID="btnDepartmentup" runat="server" CssClass="button-new"
                                            Text="Update" OnClientClick="return checkfield();" OnClick="btnDepartmentup_Click"  ></asp:Button>&nbsp;
